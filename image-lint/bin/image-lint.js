...
const argument_config = {
	...
	// ],
	'alias': {
		'bytes-per-pixel': ['b', 'bytes_per_pixel'],
		'byte-savings': ['s', 'byte_savings'],
	...
	'-help-options': {
		...
		'bytes-per-pixel': 'Set the maximum bytes per pixel before giving a warning.',
		'byte-savings': 'Set the minimum byte savings before giving a warning.',
		'color-space': 'Set the allowed color spaces separated by a comma.',
		'file-type': 'Set the allowed file types separated by a comma.',
		'max-warnings': 'Set the maximum number of warnings allowed.',
